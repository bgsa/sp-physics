...
namespace NAMESPACE_PHYSICS_TEST
{
	...
	{
		Sphere sphere = Sphere(Vec3(2.0f, 2.0f, 2.0f), Vec3(6.0f, 6.0f, 6.0f));
	...
	SP_TEST_METHOD(CLASS_NAME, Sphere_constructor_3points_Test1)
	{
		...
		Vec3 expectedCenter = Vec3(1.0f, 0.75f, 0.0f);
	...
	SP_TEST_METHOD(CLASS_NAME, Sphere_constructor_3points_Test2)
	{
		Sphere sphere = Sphere(
			...
			Vec3(12.0f, 30.0f, 10.0f)
		);

		Vec3 expectedCenter = Vec3(9.53111458f, 15.1244574f, 4.92040539f);
	...
	SP_TEST_METHOD(CLASS_NAME, Sphere_constructor_4points_Test)
	{
		...
		Vec3 expectedCenterPoint = Vec3(1.263157f, -0.842105f, 0.210526f);
	...
	SP_TEST_METHOD(CLASS_NAME, Sphere_collisionStatus_point_Test)
	{
		...
		Vec3 point = Vec3(7.071f, 5.0f, 5.0f);
	...
	SP_TEST_METHOD(CLASS_NAME, Sphere_buildFrom_AABB_Test)
	{
		...
		Vec3 expectedCenterPoint = Vec3(5.0f, 5.0f, 5.0f);
	...
	SP_TEST_METHOD(CLASS_NAME, Sphere_buildFrom_pointList_Test)
	{
		...
		Vec3 expectedCenterPoint = Vec3(6.0f, 5.0f, 5.15f);
	...
	{
		Sphere sphere1 = Sphere(Vec3(0.0f, 0.0f, 0.0f), 2.0f);
		Sphere sphere2 = Sphere(Vec3(4.0f, 0.0f, 0.0f), 1.0f);

		Sphere result = sphere1.enclose(sphere2);

		Vec3 expectedCenter = Vec3(1.5f, 0.0f, 0.0f);
	...
	{
		Sphere sphere1 = Sphere(Vec3(0.0f, 0.0f, 0.0f), 10.0f);
		Sphere sphere2 = Sphere(Vec3(1.0f, 1.0f, 1.0f), 3.0f);

		Sphere result = sphere1.enclose(sphere2);

		Vec3 expectedCenter = Vec3(0.0f, 0.0f, 0.0f);
