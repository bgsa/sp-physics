...
{
	//const sp_uint threadLength = gpu->getThreadLength(inputLength);
...
cl_mem GpuFindMinMax::execute()
{
	...
	//const sp_size threadLength = gpu->getThreadLength(8);
	//sp_float* result = ALLOC_ARRAY(sp_float, multiplyBy2(threadLength));
