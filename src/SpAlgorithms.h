...
namespace NAMESPACE_PHYSICS
{
	...
	/// <summary>
	/// Successive Over-Relaxation is iterative method to solve linear equations with sub-relaxation or over-relaxation
	/// If relaxation > 1 means over-relaxation
	/// If 0 < relaxation < 1 means sub-relaxation.
	/// </summary>
	/// <param name="A">Coeficients Matrix A</param>
	/// <param name="b"></param>
	/// <param name="rowLength">Rows of matrix A</param>
	/// <param name="columnLength">Columns of matrix A</param>
	/// <param name="relaxation">Relaxation parameter</param>
	/// <param name="initialApproximation">Initial approximation</param>
	/// <param name="output">Result x (Ax=b)</param>
	/// <param name="_epsilon">Error margin</param>
	/// <returns>void</returns>
	API_INTERFACE void sor(sp_float* A, sp_float* b, sp_uint rowLength, sp_uint columnLength, sp_float relaxation, sp_float* approximation, sp_float* output, const sp_float _epsilon = ERROR_MARGIN_PHYSIC);
