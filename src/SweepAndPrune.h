...
#define SP_SAP_MAX_COLLISION_PER_OBJECT 8
	...
	public:
		...
		///</summary>
		API_INTERFACE void setParameters(cl_mem input, sp_uint inputLength, sp_uint strider, sp_uint offset, sp_size axisLength, cl_mem outputIndexLength, cl_mem outputIndex, const sp_char* commandName);
