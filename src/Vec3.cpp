...
{
	template <typename T>
	Vec3<T>::Vec3(const T defaultValue) {
		x = defaultValue;
		y = defaultValue;
		z = defaultValue;
	}
	...
	template <typename T>
	Vec3<T> Vec3<T>::rotateY(sp_float angle)
	{
		return Vec3<T>(
	...
	template <typename T>
	Vec3<T> Vec3<T>::rotateZ(sp_float angle)
	{
		return Vec3<T>(
	...
	template <typename T>
	sp_bool Vec3<T>::operator==(const T value) const
	{
		return x == value
			&& y == value
			&& z == value;
	...
	template <typename T>
	sp_bool Vec3<T>::operator!=(const Vec3<T>& vector) const
	{
		return x != vector.x
			|| y != vector.y
			|| z != vector.z;
	...
	template <typename T>
	T& Vec3<T>::operator[](sp_int index)
	{
		sp_assert(index >= 0 && index < VEC3_SIZE);

		return reinterpret_cast<T*>(this)[index];
	}
	template <typename T>
	T Vec3<T>::operator[](sp_int index) const
	{
		sp_assert(index >= 0 && index < VEC3_SIZE);
	...
	template <typename T>
	T& Vec3<T>::operator[](sp_uint index)
	{
		sp_assert(index >= 0 && index < VEC3_SIZE);
	...
	template <typename T>
	T Vec3<T>::operator[](sp_uint index) const
	{
		sp_assert(index >= 0 && index < VEC3_SIZE);
