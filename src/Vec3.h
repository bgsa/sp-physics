...
#define VEC3_SIZE 3
	...
	public:
		...
		/// Default construct
		/// </summary>
		API_INTERFACE Vec3(const T defaultValue = T(0));
		/// <summary>
		/// Construct with args
		/// </summary>
		API_INTERFACE Vec3(const T x, const T y, const T z);
		/// <summary>
		/// Default construct
		/// </summary>
		API_INTERFACE Vec3(const Vec3<T>& value);
		...
		/// </summary>
		API_INTERFACE T tripleProduct(const Vec3<T> &v, const Vec3<T> &u) const;

		/// <summary>
		/// Add a vector from current vector
		/// </summary>
		API_INTERFACE void add(const Vec3<T>& vector);

		/// <summary>
		/// Subtract a vector from current vector
		/// </summary>
		API_INTERFACE Vec3<T> subtract(const Vec3<T>& vector);
		...
		/// </summary>
		API_INTERFACE Vec3<T> rotateY(sp_float angle);
		...
		/// </summary>
		API_INTERFACE Vec3<T> rotateZ(sp_float angle);
		...
		/// </summary>
		API_INTERFACE Vec3<T> cross(const Vec3<T>& vector) const;

		/// <summary>
		/// Dot Product / Scalar Product - between two vectors: A . B
		/// return u dot v
		/// </summary>
		API_INTERFACE T dot(const Vec3<T>& vector) const;

		/// <summary>
		/// Get the andle in radians between the vectors
		/// Obs.: if the vectors are normalized, can use: acosf(dot(vectorB));
		/// </summary>
		API_INTERFACE T angle(const Vec3<T>& vectorB) const;

		/// <summary>
		/// Get a normalized vector
		/// </summary>
		API_INTERFACE Vec3<T> normalize() const;
		...
		/// </summary>
		API_INTERFACE T squaredDistance(const Vec3<T>& vector) const;

		/// <summary>
		/// Calculate the distance (Euclidean) from this vector to another one
		/// </summary>
		API_INTERFACE T distance(const Vec3<T>& vector) const;

		/// <summary>
		/// Calculate the SIGNED distance (Euclidean) from this vector to another one
		/// </summary>
		API_INTERFACE T signedDistance(const Vec3<T>& vector) const;
		...
		/// </summary>
		API_INTERFACE Vec3<T> clone();

		/// <summary>
		/// Sum the value to vector
		/// </summary>
		API_INTERFACE Vec3<T> operator+=(const T value);
		...
		/// </summary>
		API_INTERFACE Vec3<T> operator/(const T value) const;
		...
		/// </summary>
		API_INTERFACE Vec3<T> operator-() const;
		...
		/// </summary>
		API_INTERFACE sp_bool operator==(const Vec3<T>& vector) const;
